...
use crate::{
    dto::{
        requests::forum::pagination::ForumNotificationListQuery,
        responses::{
            forum::notifications::{ForumNotificationListResponse, ForumNotificationReadResponse},
...
pub async fn list_forum_notifications(
    ...
    Query(query): Query<ForumNotificationListQuery>,
