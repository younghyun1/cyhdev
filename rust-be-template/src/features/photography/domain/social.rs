...
impl PhotographCommentResponse {
    pub fn from_comment_votestate_and_badge_info(
        comment: PhotographComment, vote_state: VoteState, public_user_id: Uuid, badge: UserBadgeInfo,
    ) -> Self {
        Self { photograph_comment_id: comment.photograph_comment_id, photograph_id: comment.photograph_id,
            user_id: public_user_id, photograph_comment_content: comment.photograph_comment_content,
            ...
            vote_state, user_name: badge.user_name, user_profile_picture_url: badge.user_profile_picture_url,
            user_country_flag: badge.user_country_flag }
    }
}

#[derive(Clone, Copy)]
pub struct VoteCounts { pub upvote_count: i64, pub downvote_count: i64 }
