...
export default function About() {
  ...
  return (
    <main lang="en-US" class={`${pageStyles.page} about-page`}>
      <section
        ...
        <section class="mb-12">
          ...
          <div class="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul class="list-disc list-inside text-sm space-y-2 text-ink">
                <li>
                  <b>oohid:</b> A CLI UUIDv4 generator in Rust. ~3x faster than libuuid. Features duplicate checking and Python/JSON formatting.
                </li>
                <li>
                  <b>impulsr:</b> A YouTube transcription and comment collection tool for marketing summaries.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul class="list-disc list-inside text-sm space-y-2 text-ink">
                ...
                <li>Volunteered at a thrift store run by people with disabilities.</li>
              </ul>
            </div>
          </div>
        </section>
          ...
          <div class="space-y-4">
            <div>
              ...
              <span class="text-sm text-ink-muted">
                Amateur landscape and portrait photographer since 2010. ~30,000 photographs archived.
              </span>
              <div class="mt-2">
                <a
                  href="/photographs"
            ...
            <div>
              ...
              <p class="text-sm text-ink mt-1">
                Former student journalist for the Sungkyun Times.
              </p>
            </div>
          </div>
        </section>
